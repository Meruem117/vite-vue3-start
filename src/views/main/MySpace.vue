<template>
  ...
  <div class="mainContent bg-gray-100">
    <div class="flex flex-col justify-start pt-14 w-full">
      <div class="flex justify-center mx-auto space-x-10 rounded border-2 border-solid border-gray-100 h-full w-2/3">
        <a-menu style="width: 256px; height: 100%;" mode="inline" theme="light" :openKeys="state.openKeys"
          ...
          <div class="flex align-middle text-3xl pl-3 pt-4 font-semibold h-16">
            ...
            <a v-if="store.state.user.role === ROLES.admin" class="text-sm font-normal ml-5 mt-3"
              @click="router.push({ path: '/admin' })">管理员</a>
          </div>
